...
class ThirdFeedUI extends StatelessWidget {
    ThirdFeedUI({Key? key,LatLng? mylatlng}  );
    late LocationData _currentPosition;

    late LatLng? mylatlng =LatLng(-1.2876959205402867, 36.72651901203068);
  ...
  Widget build(BuildContext context) {
    mylatlng  = LatLng(-1.2876959205402867, 36.72651901203068);
    return Column(
      children: [
        Row(
          children: [
